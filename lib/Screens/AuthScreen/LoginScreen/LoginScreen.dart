...
import 'package:wavetalk/Screens/AuthScreen/ForgotPaswordScreen.dart';
    ...
    return BlocListener<LoginCubit,LoginState>(
      listener: (context, state) {
        ...
        if (state is errorLoadingState) {
          ...
          Get.back(); // This will close the loading dialog
          Get.snackbar("Error", state.error,colorText: Colors.green);
        }
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      InkWell(
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder: (c)=>ForgotPaswordScreen()));
                    ...
                    child: Padding(
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          height: 50,
                          decoration: BoxDecoration(
                            color:_key.currentState?.validate()??false ? Color(0xff24786D):Colors.grey[200],
                          ...
                          child: Center(
                            child: Text(
                              ...
                              style: TextStyle(
                                fontSize: 18,
                                color: _key.currentState?.validate()??false?Colors.white:Colors.grey,
                                fontWeight: FontWeight.bold,
                              ),
                            ),
                          ),
